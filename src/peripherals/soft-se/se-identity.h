...
#define SOFT_SE_KEY_LIST                                                                                            \
    {                                                                                                               \
        {                                                                                                           \
             ...
             */                                                                                                     \
            .KeyID    = APP_KEY,                                                                                    \
            .KeyValue = { 0x25, 0xC3, 0x2F, 0x00, 0xC8, 0x05, 0x82, 0x47, 0x06, 0xC4, 0x23, 0xBE, 0x23, 0x74, 0x71, 0x02 },                                                                                   \
        },                                                                                                          \
        {                                                                                                           \
            /*!                                                                                                     \
             * Network root key                                                                                     \
             ...
             */                                                                                                     \
            .KeyID    = NWK_KEY,                                                                                    \
            .KeyValue = { 0x6A, 0x5C, 0x31, 0x9A, 0x6B, 0xD4, 0xBB, 0xCB, 0x6C, 0x96, 0x87, 0x42, 0x53, 0x64, 0x74, 0x75 },                                                                                   \
        },                                                                                                          \
        {                                                                                                           \
            /*!                                                                                                     \
